...
namespace ThemeParkApplication.Data.Migrations
{
    ...
    [Migration("20190609111246_routes")]
            ...
            modelBuilder.Entity("ThemeParkApplication.Models.WorkingHours", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, ClosingHours = new DateTime(2019, 7, 15, 14, 12, 46, 546, DateTimeKind.Local), DayOfWeek = "Sunday", StartingHours = new DateTime(2019, 7, 15, 14, 12, 46, 546, DateTimeKind.Local) },
                        new { Id = 3, ClosingHours = new DateTime(2019, 7, 15, 14, 12, 46, 546, DateTimeKind.Local), DayOfWeek = "Sunday", StartingHours = new DateTime(2019, 7, 15, 14, 12, 46, 546, DateTimeKind.Local) }
                    );
                });
