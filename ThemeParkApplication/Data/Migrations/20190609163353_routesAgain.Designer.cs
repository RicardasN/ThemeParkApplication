...
namespace ThemeParkApplication.Data.Migrations
{
    ...
    [Migration("20190609163353_routesAgain")]
    partial class routesAgain
    {
            ...
            modelBuilder.Entity("ThemeParkApplication.Models.WorkingHours", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, ClosingHours = new DateTime(2019, 7, 15, 19, 33, 52, 605, DateTimeKind.Local), DayOfWeek = "Sunday", StartingHours = new DateTime(2019, 7, 15, 19, 33, 52, 605, DateTimeKind.Local) },
                        new { Id = 3, ClosingHours = new DateTime(2019, 7, 15, 19, 33, 52, 605, DateTimeKind.Local), DayOfWeek = "Sunday", StartingHours = new DateTime(2019, 7, 15, 19, 33, 52, 605, DateTimeKind.Local) }
                    );
                });
