...
namespace ThemeParkApplication.Data.Migrations
{
    ...
    [Migration("20190608124134_messagesUser")]
    partial class messagesUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThemeParkApplication.Models.WorkingHours", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, ClosingHours = new DateTime(2019, 7, 14, 15, 41, 34, 160, DateTimeKind.Local), DayOfWeek = "Saturday", StartingHours = new DateTime(2019, 7, 14, 15, 41, 34, 160, DateTimeKind.Local) },
                        new { Id = 3, ClosingHours = new DateTime(2019, 7, 14, 15, 41, 34, 160, DateTimeKind.Local), DayOfWeek = "Saturday", StartingHours = new DateTime(2019, 7, 14, 15, 41, 34, 160, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("ThemeParkApplication.Models.Ticket", b =>
                {
                    b.HasOne("ThemeParkApplication.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
